      ...
      <div class="batch-action-bar-content glass-panel">
        ...
        <div class="batch-info">
          ...
          <span class="text-sm font-semibold text-[var(--app-text)]">
            已选择 <span class="font-mono-data text-[var(--neon-primary)]">{{ selectedCount }}</span> 项
          </span>
        </div>
        ...
        <div class="batch-actions">
          ...
          <button class="batch-btn-icon batch-btn-danger" title="批量删除" @click="emit('confirm-batch-delete')">
            <Trash2 :size="18" />
          </button>
        </div>
