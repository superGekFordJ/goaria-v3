...
<template>
  <div class="test-simulator">
    ...
    <div class="actions">
      ...
      <button :disabled="isRunning" class="btn" @click="injectTasks(300)">+300 任务</button>
      <button :disabled="isRunning" class="btn" @click="injectTasks(500)">+500 任务</button>
    ...
    <div class="metrics">
      ...
      <div class="metric">
        <span class="label">Stopped 数量</span>
        <span class="value">{{ taskStore.stoppedTasks.length }}</span>
      </div>
    </div>
