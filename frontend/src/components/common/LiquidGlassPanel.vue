...
<template>
  ...
  >
    <template v-if="uiStore.effects === 'full'">
      <!-- Shadow and Edge Lighting Layer -->
      <div
        class="absolute inset-0 z-0 pointer-events-none transition-all duration-300"
        :class="[
          radius,
          active
            ? 'shadow-[inset_0px_0px_0px_1px_rgba(0,0,0,0.16),inset_0px_1px_0px_rgba(255,255,255,0.8),inset_0px_-1px_1px_rgba(0,0,0,0.16),0px_2px_4px_rgba(0,0,0,0.05),0px_8px_24px_rgba(0,0,0,0.08)] dark:shadow-[inset_0px_0px_0px_1px_rgba(0,0,0,0.2),inset_0px_1px_0px_rgba(255,255,255,0.15),0px_1px_2px_rgba(0,0,0,0.2),0px_4px_12px_rgba(0,0,0,0.3)]'
            : 'shadow-none',
        ]"
      ></div>

      <!-- Base Color & Backdrop Filter Layer -->
      <div
