...
// SaveStateWithOptions and stashes the record for EventError.State. Either
// mode may skip persistence entirely when nothing resumable remains (see the
// remainingBytes==0 gap handling below).
